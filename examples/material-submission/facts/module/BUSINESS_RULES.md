...
| --- | --- | --- | --- | --- | --- | --- |
| BR-001 | 申报事项固定显示为“公共空间微更新材料申报”。 | 已确认 | 页面事项信息 | DEC-001：事项名称是本案例原创的虚构展示文案 | `examples/material-submission/index.html` 的事项字段 | 2026-09-24 |
...
| BR-003 | 三项必备演示材料全部确认后才可提交；勾选仅表示已备齐，不上传文件。 | 已确认 | 材料清单与提交校验 | Issue #8：使用虚构材料清单并验证必填；DEC-001：本案例以勾选确认、不上传文件 | `examples/material-submission/index.html` 材料说明；`examples/material-submission/app.js` 的必填判断 | 2026-09-24 |
