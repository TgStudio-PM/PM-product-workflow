...
| BR-003 | “项目背景说明”和“迭代计划摘要”为必备材料，均确认后才可提交；“页面流程草图”为可选材料。勾选表示已备齐，不上传文件。必备材料计数只统计两项必备材料。 | 已确认 | 材料清单与提交校验 | Issue #8：使用虚构材料清单并验证必填；Issue #12 与 DEC-002：页面流程草图改为可选 | `examples/material-submission/index.html` 的必备/可选标识与计数；`examples/material-submission/app.js` 的必备项校验和勾选材料保存 | 2026-09-24 |
